...
public class IocMain {
	...
	public void setup(){
		...
		context = 
				new ClassPathXmlApplicationContext("classpath:kr/or/ddit/ioc/application-ioc.xml");
	}
	...
	public void setterDITest(){
		...
		IocServiceInf service = (IocServiceInf)context.getBean("iocSetterService");

		/***Then***/
		//DL을 통해 얻은 스프링 bean의 hello 메소드호출 결과비교
		assertEquals("sayHello", service.hello());

	}
	
	//spring bean signleton scope test
	@Test
	...
	public void prototypeTest(){
		...
		//(프로토타입의 경우 dl을 할때 마다 새로운 객체를 리턴 하기 때문에)
	...
	public void singletonDIprototypeTest(){
		...
		IocServiceInf iocService = 
					(IocServiceInf)context.getBean("iocSingletonService");
