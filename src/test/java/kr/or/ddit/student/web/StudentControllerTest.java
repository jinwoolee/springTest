 ...
 *  
 *  1.Spring을 junit에서 사용할수 있도록 설정 : @RunWith(SpringJunit4ClassRunner.class)
 *  2.Spring 설정 파일 설정 : @ContextConfiguration
 *  3.Spring container가 웹 어플리케이션 컨텍스트로 생성될 수있도록 설정 : @WebAppConfiguration
 *  
 *  4.스프링 웹 환경과 동일하게 요청을 할수 있도록 dispatcherServlet 역할을 하는 MockMvc 객체생성
...
public class StudentControllerTest {
	...
	public void studentListTest() throws Exception {
		...
		List<StudentVo> studentList =
					(List<StudentVo>) mav.getModel().get("studentList");
